...
# Obtiene la ruta del directorio raíz del proyecto de forma dinámica
BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
csv_path = os.path.join(BASE_DIR, 'data', 'processed', 'dataset_final.csv')

# Carga el archivo de forma segura
